...
public class TERenderer {
     ...
     */
    public void renderFrame(TETile[][] world, World W, String HUD) {
        ...
        Font fontBig2 = new Font("Monaco", Font.BOLD, 20);
        StdDraw.setFont(fontBig2);
        StdDraw.setPenColor(Color.PINK);
        StdDraw.text(15, 49, "Number of Beans Left:");
        String num = "" + W.getRemainingBean();
        StdDraw.text(24, 49, num);
        System.out.println(HUD);
        StdDraw.text(10, 45, HUD);
        StdDraw.show();
    }
}
